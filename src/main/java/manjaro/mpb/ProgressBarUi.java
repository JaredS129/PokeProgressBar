...
import manjaro.mpb.config.PikachuProgressBarSettingsState;
...
public class ProgressBarUi extends BasicProgressBarUI {
    ...
    public ProgressBarUi() {
        try {
            bimage = ImageIO.read(this.getClass().getResource("/grass.png"));
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
    ...
    protected void paintIndeterminate(Graphics g2d, JComponent c) {
        ...
        Icons.POKEBALL.paintIcon(progressBar, g, offset2 - JBUIScale.scale(3), -JBUIScale.scale(-2));
    ...
    protected void paintDeterminate(Graphics g, JComponent c) {
        ...
        PikachuProgressBarSettingsState.getInstance().selectedCharacter.getIcon().paintIcon(progressBar, g2, amountFull - JBUIScale.scale(5), -JBUIScale.scale(1));
        g2.translate(0, -(c.getHeight() - h) / 2);
